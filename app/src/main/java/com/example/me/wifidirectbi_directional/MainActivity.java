...
/*
  ...
  devices. This file contain some callback methods, some general methods which
  are going to be used throughout the application. It also contains registration
  of a Broadcast Receiver, a method to reset the UI.
 */
